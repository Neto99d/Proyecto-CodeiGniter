...
class ManageProd_model extends CI_Model 
{

    protected $manageProd = 'productos';
    ...
    public function select_all($limit = NULL, $start = NULL, $count = NULL)
    {
      ...
      $query = $this->db->get($this->manageProd);
    ...
    public function insert($data)
    {
      ...
      $this->db->set($data);
      $this->db->insert($this->manageProd);
    ...
    public function update($data, $id)
    {
      ...
      $this->db->set($data);
      $this->db->where("id", $id);
      $this->db->update($this->manageProd);
    ...
    public function delete($id)
    {
      ...
      $this->db->where("id", $id);
      $this->db->delete($this->manageProd);
...
/* End of file ManageProd_model.php and path \application\models\ManageProd_model.php */

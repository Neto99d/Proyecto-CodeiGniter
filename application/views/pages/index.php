                ...
                <div class="row row-cols-1 row-cols-md-3 g-4">
                    ...
                    <div class="col">
                        <div class='card h-100'>
                            <img src='<?= base_url('assets\images\imagesProd/').$row->imagenProd?>' class='card-img-top'
                            ...
                            <div class='card-body'>
                                ...
                                <?php else: ?>
                                <a href="<?= base_url('carrito/AddCart/').$row->id?>"
        ...
        <div class='container-fluid'>
            ...
            <div class='container-fluid'>
                <div class="row row-cols-1 row-cols-md-3 g-4">
                    ...
                    <div class="col">
                        <div class='card h-100'>
                            <img src='<?= base_url('assets\images\imagesProd/').$row->imagenProd?>' class='card-img-top rounded'
                                width='100' height='200'>
                            <div class='card-body'>
                                <h5 class='card-title'><?php echo $row->nombre ?></h5>
                                <p class='card-text'><?php echo $row->descripcion ?></p>

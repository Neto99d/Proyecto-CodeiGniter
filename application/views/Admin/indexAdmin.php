                ...
                <div class='container'>
                    ...
                    <div class='align-content-end'>
                        ...
                        <ul class='nav-justified'>
                            ...
                            <a href='' data-bs-toggle="tooltip" data-bs-placement="bottom" title="Mi carrito"><svg
                                    xmlns='http://www.w3.org/2000/svg' width='24' height='24' fill='currentColor'
                                    class='bi bi-cart' viewBox='0 0 16 16'>
                                    <path
                                        d='M0 1.5A.5.5 0 0 1 .5 1H2a.5.5 0 0 1 .485.379L2.89 3H14.5a.5.5 0 0 1 .491.592l-1.5 8A.5.5 0 0 1 13 12H4a.5.5 0 0 1-.491-.408L2.01 3.607 1.61 2H.5a.5.5 0 0 1-.5-.5zM3.102 4l1.313 7h8.17l1.313-7H3.102zM5 12a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm7 0a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm-7 1a1 1 0 1 1 0 2 1 1 0 0 1 0-2zm7 0a1 1 0 1 1 0 2 1 1 0 0 1 0-2z' />
                                </svg></a>
                            <a href='' data-bs-toggle="tooltip" data-bs-placement="bottom" title="Iniciar sesión"><svg
                            ...
                            <ul class='navbar-nav me-auto mb-2 mb-lg-0'>
                                ...
                                <li class='nav-item dropdown'>
                                    ...
                                    <ul class='dropdown-menu' aria-labelledby='navbarDropdown'>
                                        ...
                                        <li><a class='dropdown-item' href='#'><svg xmlns='http://www.w3.org/2000/svg'
                                                    width='17' height='17' fill='currentColor' class='bi bi-cart'
                                                    viewBox='0 0 16 16'>
                                                    <path
                                                        d='M0 1.5A.5.5 0 0 1 .5 1H2a.5.5 0 0 1 .485.379L2.89 3H14.5a.5.5 0 0 1 .491.592l-1.5 8A.5.5 0 0 1 13 12H4a.5.5 0 0 1-.491-.408L2.01 3.607 1.61 2H.5a.5.5 0 0 1-.5-.5zM3.102 4l1.313 7h8.17l1.313-7H3.102zM5 12a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm7 0a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm-7 1a1 1 0 1 1 0 2 1 1 0 0 1 0-2zm7 0a1 1 0 1 1 0 2 1 1 0 0 1 0-2z' />
                                                </svg> Carrito</a></li>
            ...
            <div id='carouselExampleCaptions' class='carousel slide' data-bs-ride='false'>
                ...
                <div class="carousel-inner">
                    <div class='carousel-item active'>
                        <img src='assets/images/R.jfif' class="rounded mx-auto d-block" width="1200" height="450">
                    ...
                    <div class='carousel-item'>
                        <img src='assets/images/R (1).jfif' class="rounded mx-auto d-block" width="1200" height="450">
                        <div class='carousel-caption d-none d-md-block'>
                    ...
                    <div class='carousel-item'>
                        <img src='assets/images/R (3).jfif' class="rounded mx-auto d-block" width="1200" height="450">
                        <div class='carousel-caption d-none d-md-block'>
    ...
    <footer>
        ...
        <div class="container">
            <footer class="py-3 my-4">
                ...
                <p class="text-center text-muted">&copy; 2022 Interfaz Beta</p>
            </footer>
        </div>
    </footer>
